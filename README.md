...
* [1] NuRadioReco/modules/voltageToEfieldConverter.py
...
If you want to use the ray functionality, you will need to use the rayReader class and generate a .h5 file with rays: (https://github.com/MatthewMarsee/ray_reader)
